...
Current protocol: **v0.3**. Current companion book: **v2.0.16 digital edition,
...
- [Versioned v0.3 PDF](releases/v0.3/book-v2.0.16/The_Alignment_Industrial_Complex-Technical-Field-Guide-v0.3.pdf)
- [Versioned v0.3 source archive](releases/v0.3/book-v2.0.16/The_Alignment_Industrial_Complex-Technical-Field-Guide-v0.3-source.zip)
- [Release checksums](releases/v0.3/book-v2.0.16/CHECKSUMS.sha256)
